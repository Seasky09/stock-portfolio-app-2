...
function injectLayoutFixStyles() {
  ...
  style.textContent = [
    ...
    '.marketCaption,.marketPeriodLabel{display:none !important;}',
    '@media (max-width:640px){.card > h2{padding:0 4px;margin-bottom:12px;}.card > .row.between{padding:0 4px;}.card > .row.between .btn{margin-right:0;}}'
  ].join('\n');
